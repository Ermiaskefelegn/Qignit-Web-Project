...
<html lang="en">
<head>
<title>Qignet Music store</title>
<meta charset="utf-8">
								...
								<div class="col fill_height">
									<div class="home_container d-flex flex-column align-items-center justify-content-start">
										<div class="home_content">
											<div class="home_title">New Release</div>
											<div class="home_subtitle">Hot</div>
														...
														<div class="product home_item_large">
															...
															<div class="product_content">
																<div class="product_info d-flex flex-row align-items-start justify-content-start">
																	<div>
																		<div>
																			<div class="product_name"><a href="product.html">Album</a></div>
														...
														<div class="product home_item_large">
															...
															<div class="product_content">
																<div class="product_info d-flex flex-row align-items-start justify-content-start">
																	<div>
																		<div>
																			<div class="product_name"><a href="product.html">Haymanot</a></div>
																			<!-- <div class="product_category">In <a href="category.html">Category</a></div> -->
																		</div>
																	</div>
																	<div class="ml-auto text-right">
														...
														<div class="product home_item_large">
															...
															<div class="product_content">
																<div class="product_info d-flex flex-row align-items-start justify-content-start">
																	<div>
																		<div>
																			<div class="product_name"><a href="product.html">Mehamud</a></div>
														...
														<div class="product home_item_large">
															...
															<div class="product_content">
																<div class="product_info d-flex flex-row align-items-start justify-content-start">
																	<div>
																		<div>
																			<div class="product_name"><a href="product.html">Tedy </a></div>
																			<!-- <div class="product_category">In <a href="category.html">Category</a></div> -->
																		</div>
																	</div>
																	<div class="ml-auto text-right">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-6 offset-lg-3">
						<div class="section_title text-center">Tizeta</div>
					</div>
				</div>
					...
					<div class="col">
						<div class="page_nav">
							<ul class="d-flex flex-row align-items-start justify-content-center">
								...
								<li><a href="index.blade.php">Top release</a></li>
								<li><a href="category.blade.php">New release</a></li>
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name"><a href="product.html">Haymanot</a></div>
											<!-- <div class="product_category">In <a href="category.html">soul</a></div> -->
										</div>
									</div>
									<div class="ml-auto text-right">
										<div class="rating_r rating_r_4 home_item_rating"><i></i><i></i><i></i><i></i><i></i></div>
										<div class="product_price text-right">150<span>.99birr</span></div>
									</div>
								</div>
								<div class="product_buttons">
									<div class="text-right d-flex flex-row align-items-start justify-content-start">
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									...
									<div class="ml-auto text-right">
										<div class="rating_r rating_r_4 home_item_rating"><i></i><i></i><i></i><i></i><i></i></div>
										<div class="product_price text-right">153<span>.99</span></div>
									</div>
								</div>
								<div class="product_buttons">
									<div class="text-right d-flex flex-row align-items-start justify-content-start">
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name"><a href="product.html">Tedy Afro </a></div>
											<!-- <div class="product_category">In <a href="category.html">Category</a></div> -->
										</div>
									</div>
									<div class="ml-auto text-right">
										<div class="rating_r rating_r_4 home_item_rating"><i></i><i></i><i></i><i></i><i></i></div>
										<div class="product_price text-right">83<span>.99</span></div>
									</div>
								</div>
								<div class="product_buttons">
									<div class="text-right d-flex flex-row align-items-start justify-content-start">
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name"><a href="product.html">Abey </a></div>
											<!-- <div class="product_category">In <a href="category.html">Category</a></div> -->
										</div>
									</div>
									<div class="ml-auto text-right">
										<div class="rating_r rating_r_4 home_item_rating"><i></i><i></i><i></i><i></i><i></i></div>
										<div class="product_price text-right">93<span>.99</span></div>
									</div>
								</div>
								<div class="product_buttons">
									<div class="text-right d-flex flex-row align-items-start justify-content-start">
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name"><a href="product.html">Tewodros </a></div>
											<!-- <div class="product_category">In <a href="category.html">Category</a></div> -->
										</div>
									</div>
									<div class="ml-auto text-right">
										<div class="rating_r rating_r_4 home_item_rating"><i></i><i></i><i></i><i></i><i></i></div>
										<div class="product_price text-right">55<span>.99</span></div>
									</div>
								</div>
								<div class="product_buttons">
									<div class="text-right d-flex flex-row align-items-start justify-content-start">
						...
						<div class="product">
							...
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											<div class="product_name"><a href="product.html">Eyob </a></div>
											<!-- <div class="product_category">In <a href="category.html">Category</a></div> -->
										</div>
									</div>
									<div class="ml-auto text-right">
										<div class="rating_r rating_r_4 home_item_rating"><i></i><i></i><i></i><i></i><i></i></div>
										<div class="product_price text-right">113<span>.99</span></div>
									</div>
								</div>
								<div class="product_buttons">
									<div class="text-right d-flex flex-row align-items-start justify-content-start">
							...
							<div class="box">
								...
								<div class="box_content d-flex flex-row align-items-center justify-content-start">
									...
									<div class="box_right text-center">
										<div class="box_title">Collections</div>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-4 footer_col">
							<div class="footer_about">
								...
								<div class="footer_about_text">
									<p>The music industry now a days is growing in a rapid rate towards global domination, also in our country it is a very huge industry where musicians can sell and publish their products (music).Since this kind of creative product is regarded as an intellectual property of individuals, as a result it must be patented and the right to copy and distribute is should only be given to the owner of this intellectual work..</p>
								</div>
							</div>
						</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Qignet online music store <!-- <i class="fa fa-heart-o" aria-hidden="true"> --><!-- </i> by <a href="https://colorlib.com" target="_blank">Colorlib</a> -->
